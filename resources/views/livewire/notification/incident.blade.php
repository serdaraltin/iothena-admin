                                    ...
                                    <div class="col-12 text-center mt-3">
                                        @if($incident->hasMedia('photo'))
                                            @php
                                                ...
                                                Storage::disk('public')->put('photos/'.$fileName, $fileContent);
                                            @endphp
                                            <img src="{{ Storage::disk('public')->url('photos/'.$fileName) }}"
                                                 class="img-fluid"
