            ...
            <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close" wire:click="closeDeviceDetails"></button>
                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" wire:click="refreshDeviceDetails({{$device->id}})">
                            {{__('general.refresh')}}</button>
                        <button type="button" class="btn btn-secondary" wire:click="closeDeviceDetails">{{__('general.close')}}
                    </div>
                </div>
            </div>
        </div>
