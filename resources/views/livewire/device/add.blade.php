                                    ...
                                    <form wire:submit.prevent="updateDevice">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-6">
                                                ...
                                                <input disabled wire:model="device_id" value="" type="text" id="device_id" name="name" class="form-control" placeholder="Enter device name">
                                            </div>
                                            <div class="col-6">
                                                <label for="name" class="form-label">{{__('general.name')}}</label>
                                                <input  wire:model="name" value="" id="name" name="name" class="form-control" placeholder="Enter device name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input  wire:model="location" value="" type="text" id="location" name="location" class="form-control" placeholder="Enter device location">
                                            </div>
                                            <div class="col-6">
                                                <label for="room_size" class="form-label">{{__('device.room-size')}} (m²)</label>
                                                <input  wire:model="room_size" value="" type="number" id="room_size" name="room_size" class="form-control" placeholder="Enter room size">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-6">
                                                ...
                                                <input  wire:model="ip_address" value="" type="text" id="ip_address" name="ip_address" class="form-control" placeholder="Enter device IP address">
                                            </div>

                                            <div class="col-6">
                                                <label for="base_noise_level" class="form-label">{{__('device.base-noise-level')}} (dB)</label>
                                                <input  wire:model="base_noise_level" value="" type="number" id="base_noise_level" name="base_noise_level" class="form-control" placeholder="Enter base noise level">
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-6">
                                                ...
                                                <input  wire:model="port" value="" type="number" id="port" name="port" class="form-control" placeholder="Enter port number">
                                            </div>
                                            <div class="col-6">
                                                <label for="threshold" class="form-label">{{__('device.threshold')}}</label>
                                                <input  wire:model="threshold" value="" type="number" id="threshold" name="threshold" class="form-control" placeholder="Enter threshold value">
                                            </div>
                                        </div>
