        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="header-title">
                    <h4 class="card-title mb-0">{{__('menu.services')}}</h4>
                </div>
            ...
            <div class="card-body p-0">
                <div class="table-responsive mt-4">
                    <table id="basic-table" class="table table-striped mb-0" role="grid">
                        <thead >
                        <tr>
                            <th class="border-1">{{__('datatable.status')}}</th>
                            <th class="border-1">{{__('datatable.name')}}</th>
                            <th class="border-1">{{__('datatable.type')}}</th>
                            <th class="border-1">{{__('datatable.description')}}</th>
                                ...
                                <tr>
                                    ...
                                    <td class="border-1">
                                        <div class="text-start" style="word-wrap: break-word; white-space: normal;">
                                            <h6 class="text-{{$status_color}} ">
                                                <strong>
                                                    {{strtoupper(__('datatable.'.$service->status))}}
                                                </strong>
                                            </h6>
                                        </div>
                                    </td >
                                    ...
                                    <td class="border-1">
                                        <div class="d-flex flex-wrap align-items-start">
                                            <h6 class="">{{ strtoupper($service->type)}}</h6>
                                        </div>
                                    </td >
                                    ...
                                    <td class="border-1">
                                        <div class="text-start" style="word-wrap: break-word; white-space: normal;">
                                            <h6 class="">{{ $service->description}}</h6>
                                        </div>
                                    </td >

                                    <td class="border-1">
                                        <div class="text-start" style="word-wrap: break-word; white-space: normal;">
                                            <h6 class="">{{ $service->created_at}}</h6>
                                        </div>
                                    </td >
