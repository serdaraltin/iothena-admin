@php use App\Models\Incident\Incident; @endphp
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="header-title">
                    <h4 class="card-title mb-0">{{__('menu.incident-notifications')}}</h4>
                </div>
                ...
                <div class="table-responsive mt-4">
                    <table id="basic-table" class="table table-striped mb-0" role="grid">
                        ...
                        <tr>
                            ...
                            <th class="border-1">{{__('notification.title')}}</th>
                            <th class="border-1">{{__('notification.message')}}</th>
                            <th class="border-1">{{__('notification.read')}}</th>
                        ...
                        @if($notifications)
                            @foreach($notifications as $notification)
                                ...
                                @php
                                    ...
                                    $incident = Incident::where('id', $notification['model_id'] )->first();
                                ...
                                <tr @if($priority_color =="danger") class="bg-soft-danger" @endif>
                                    ...
                                    <td class="border-1">
                                        <div class="d-flex flex-wrap align-items-start">
                                            <h6 class="text-{{$priority_color}}">{{ strtoupper($notification['priority'])}}</h6>
                                        </div>
                                    </td>
                                    ...
                                    <td class="border-1">
                                        ...
                                        <button wire:click="openDeviceDetails({{$incident->device->id}})" type="button"
                                    ...
                                    <td class="border-1">
                                        <div class="d-flex flex-wrap align-items-start">
                                            <h6>{{ $incident->device->location}}</h6>
                                        </div>
                                    </td>
                                    ...
                                    <td class="border-1">
                                        <button wire:click="openIncidentDetails({{$incident->id}})" type="button" class="btn btn-sm btn-soft-info">
